...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_header_menu__WEBPACK_IMPORTED_MODULE_2__["headerMenu"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана

  window.addEventListener('load', function () {
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
    Object(_modules_map__WEBPACK_IMPORTED_MODULE_3__["getYaMap"])();
  });
}); // ---------------------------------
...
/*!***************************!*\
  !*** ./js/modules/map.js ***!
  \***************************/
/*! exports provided: getYaMap */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getYaMap", function() { return getYaMap; });
var getYaMap = function getYaMap() {
